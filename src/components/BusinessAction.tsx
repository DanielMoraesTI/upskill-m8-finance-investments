...
// Esta função é uma função auxiliar que converte o tipo de investimento selecionado pelo usuário (ações, fundos imobiliários ou renda fixa) em um ID numérico correspondente, que é utilizado para filtrar os ativos disponíveis e registrar as operações de investimento corretamente. Ela recebe como parâmetro o tipo de investimento e retorna o ID correspondente (1 para ações, 2 para fundos imobiliários, 3 para renda fixa) ou null se o tipo de investimento não for reconhecido.
